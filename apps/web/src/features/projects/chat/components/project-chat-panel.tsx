...
import type { ProjectChatConnectionStatus } from '../hooks/use-project-chat-realtime';
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <CardDescription className="mt-1">
                {area.type === 'PUBLIC' ? '项目成员共享的公共讨论区' : '只有显式成员可见的私有协作区'}
              </CardDescription>
            </div>
          </div>
