...
export function DashboardPrototype() {
  return (
    <main className="dashboard-prototype-page min-h-dvh bg-[#adb4be] text-[#20211f]">
      <div
        className="dashboard-prototype-viewport flex min-h-[100dvh] w-full flex-col overflow-hidden border border-white/60
