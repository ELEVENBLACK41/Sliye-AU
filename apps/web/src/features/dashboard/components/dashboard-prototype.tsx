...
export function DashboardPrototype() {
  return (
    <main className="min-h-dvh bg-[#adb4be] text-[#20211f]">
      <div className="flex min-h-[calc(100dvh-1.5rem)] w-full flex-col overflow-hidden border border-white/60 bg-[radial-gradient(circle_at_88%_20%,rgba(255,227,101,0.45),transparent_28%),linear-gradient(135deg,#f3f5f5_0%,#f5f2e8_58%,#fff4bd_100%)] p-4 shadow-2xl shadow-slate-700/20 sm:min-h-[calc(100dvh-2rem)] sm:p-6 lg:min-h-[calc(100dvh-2.5rem)]">
        {/* navigation 栏目 */}
