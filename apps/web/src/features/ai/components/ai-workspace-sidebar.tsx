...
import { Archive, MoreHorizontal, PanelLeft, Pencil, Pin, PinOff, Plus, Trash2 } from 'lucide-react';
...
import type { AiWorkspaceStaticData, AiWorkspaceThreadPreview } from './ai-workspace-types';
