...
- AI 模块的总体实施以 `apps/web/src/app/(ai)/ai/doc/Decision Agent与RAG可测试实施路线图-2026-08-17.md` 为当前路线图；第二阶段的具体实施以同目录 `AI第二阶段实施计划-2026-08-25.md` 为唯一详细基线，第三阶段的具体实施以同目录 `AI第三阶段实施计划-2026-08-28.md` 为唯一详细基线。开始前先核对对应阶段的目标、工作项、测试和完成标志，不脱离路线图一次性铺开实现。
